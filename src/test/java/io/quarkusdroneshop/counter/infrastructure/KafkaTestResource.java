...
public class KafkaTestResource implements QuarkusTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        ...
        Map<String, String> props3 = InMemoryConnector.switchOutgoingChannelsToInMemory("qdca10-in");
        Map<String, String> props4 = InMemoryConnector.switchOutgoingChannelsToInMemory("qdca10pro-in");
